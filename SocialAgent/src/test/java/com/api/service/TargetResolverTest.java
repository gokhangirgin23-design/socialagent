...
class TargetResolverTest {
    ...
    void noneModuHashtagServisindeSektorUrlUretir() {
        ...
        ReportRequest req = request("NONE", null);
        List<ScrapeTarget> targets = resolver.resolve(req);
    ...
    void ownOnlyKendiHesapVeSektorHedefleriUretir() {
        ...
        ReportRequest req = request("OWN_ONLY", ownAccountId);
        List<ScrapeTarget> targets = resolver.resolve(req);
    ...
    void bothModuHashtagServisiniCagirmaz() {
        ...
        ReportRequest req = request("BOTH", ownAccountId);
        List<ScrapeTarget> targets = resolver.resolve(req);
    ...
    // Test için örnek ReportRequest üretir
